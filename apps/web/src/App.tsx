...
const lazyPage = <T extends Record<string, React.ComponentType>>(loader: () => Promise<T>, key: keyof T) =>
...
const VulnerabilitiesPage = lazyPage(() => import("@/features/security/VulnerabilitiesPage"), "VulnerabilitiesPage");
const CodeScanningPage = lazyPage(() => import("@/features/security/CodeScanningPage"), "CodeScanningPage");
const SupplyChainPage = lazyPage(() => import("@/features/supplyChain/SupplyChainPage"), "SupplyChainPage");
const DependenciesPage = lazyPage(() => import("@/features/dependencies/DependenciesPage"), "DependenciesPage");
const ArtifactsPage = lazyPage(() => import("@/features/artifacts/ArtifactsPage"), "ArtifactsPage");
const RepositoriesPage = lazyPage(() => import("@/features/repositories/RepositoriesPage"), "RepositoriesPage");
const RepoDetailPage = lazyPage(() => import("@/features/repositories/RepoDetailPage"), "RepoDetailPage");
